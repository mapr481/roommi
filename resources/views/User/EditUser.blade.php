                        ...
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-8">
                                            <div class="title-single-box">
                                                <h1 class="title-single">Editar Información</h1>                                            
                                            </div>
                                        </div>                
                                    </div>
                                </div>
                            ...
                            <form method="POST" action="{{ route("UpdateUser", $user->id) }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input id="nacimiento" type="date" class="form-control form-control-lg texto @error('nacimiento') is-invalid @enderror" name="nacimiento" value="{{ old('nacimiento', Carbon\Carbon::parse($user->nacimiento)->format('Y-m-d')) }}" required autocomplete="nacimiento" autofocus>
